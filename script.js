...
function blink() 
{
	document.getElementById("picture").src='images/closed.gif'; //Changes the src of the image that has the id, picture, to an image of eyes closed.
	document.getElementById("picture2").src='images/closed.gif'; //Changes the src of the image that has the id, picture2, to an image of eyes closed.
	setTimeout(open, 500); //Sets up timer event that will go to the open() function in 500 milliseconds.
}

//This function is named poked(). Its purpose is to change the image to make it look like they got poked.
function poked(eyep)
{
	document.getElementById("direction").innerHTML = 'Ow!';
	document.getElementById(eyep).src='images/closed.gif'; //Changes the src of the image that has the id, picture, to an image of eyes closed.
}
...
function open()
{
	...
	{
		document.getElementById("direction").innerHTML = 'foward';
		document.getElementById("picture").src='images/forward.gif'; //Changes the src of the image that has the id, picture, to an image of eyes looking forward.
		document.getElementById("picture2").src='images/forward.gif'; //Changes the src of the image that has the id, picture2, to an image of eyes looking forward.
	}
...
function mouseover(x)
{
	...
	document.getElementById("direction").innerHTML = x;
